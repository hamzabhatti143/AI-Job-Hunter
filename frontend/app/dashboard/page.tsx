...
export default function DashboardPage() {
  ...
  const [form, setForm] = useState({ location: '', role_preference: '', resume: null as File | null })
        ...
        <form onSubmit={handleRun} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-gray-600 text-xs mt-1">Enter a country name for the best results — e.g. Pakistan, United Kingdom, United States. Or type <span className="text-gray-500">Remote</span>.</p>
            </div>
            <div>
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-xl p-5 space-y-3">
              ...
              <div className="space-y-2">
                {[
                  ...
                  'Searching jobs posted this week via Google Jobs & Google Search…',
