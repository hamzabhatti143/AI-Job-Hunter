...
export default function Signup() {
  ...
  const [creds, setCreds] = useState({ clientId: '', clientSecret: '', redirectUri: 'https://hamzabhatti-outreach-tool-82fb335.hf.space/auth/gmail/callback' })
                ...
                <section className="bg-gray-900 border border-gray-800 rounded-2xl p-5 space-y-4">
                  ...
                  <ol className="space-y-2.5 text-sm">
                    {[
                      ...
                      <>Create credentials: APIs & Services → Credentials → Create Credentials → OAuth client ID → Web application → add redirect URI: <span className="bg-gray-800 px-1.5 py-0.5 rounded font-mono text-xs text-green-400">https://hamzabhatti-outreach-tool-82fb335.hf.space/auth/gmail/callback</span></>,
